...
def getvals():
    print("Your form is sucessfully submited")
    print({namevalue.get(),phonevalue.get(),gendervalue.get(),emailvalue.get(),tiketpricevalue.get()})
    

    with open(L12_Record.txt","w") as f:
    pass
    f.write("{namevalue.get(),phonevalue.get(),gendervalue.get(),emailvalue.get(),tiketpricevalue.get()}\n")
